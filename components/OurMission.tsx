  ...
  return (
    <section className="from-background-primary to-background mb-4 bg-gradient-to-b from-50% to-50%">
      <div className="container mx-auto px-4">
        <div className="relative flex flex-col gap-5 rounded-t-3xl rounded-br-[200px] rounded-bl-3xl bg-gradient-to-br from-[#89a895] to-[#70a8a5] bg-bottom p-6 pb-20 shadow-xl lg:flex-row lg:items-center lg:gap-10 lg:px-8 lg:py-10 xl:py-18 xl:pr-24 xl:pl-14">
