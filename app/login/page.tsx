...
const LoginPage = () => {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-background container mx-auto flex justify-center px-4 pt-2 pb-8 lg:py-10">
        <div className="mt-8 flex max-w-[500px] flex-1 flex-col gap-4">
          ...
          <div className="flex items-center justify-between gap-4 px-1">
            ...
            <Link
              ...
              className="cursor-pointer text-xs font-medium text-black/80"
            >
